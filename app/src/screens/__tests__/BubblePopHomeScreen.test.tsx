...
describe('BubblePopHomeScreen', () => {
  ...
  it('renders title and play button', () => {
    const { getByText } = render(
      <BubblePopHomeScreen navigation={navigation as any} />
    );
    expect(getByText('bubblePop.home.title')).toBeTruthy();
    expect(getByText('bubblePop.home.play')).toBeTruthy();
  });
  ...
  it('shows best score when greater than 0', () => {
    ...
    expect(getByText('bubblePop.home.bestScore')).toBeTruthy();
  });
  ...
  it('does not show best score when 0', () => {
    ...
    expect(queryByText('bubblePop.home.bestScore')).toBeNull();
  });
  ...
  it('navigates to game on play press', () => {
    ...
    fireEvent.press(getByText('bubblePop.home.play'));
    expect(mockNavigate).toHaveBeenCalledWith('BubblePopGame');
  });
