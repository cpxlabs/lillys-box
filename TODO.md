...
- [x] Add ErrorBoundary component with root-level and per-game wrapping (M5)
- [x] ErrorBoundary test suite (5 tests)

### Mar 2026 — Features & Quality
...
- [x] Add background music support with mute toggle
...
### Feb 2026
- [x] Game Review System — modal with comments, stars, media, Firebase sync, reactions
...
### Jan 2026
- [x] Google OAuth authentication + guest mode with multi-user data isolation
- [x] Fix Google OAuth client ID — now read from EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID env var
...
- [x] Add tests for various screens (500+ tests, 99%+ passing)
...
- [x] Vercel web deployment with SPA rewrites
- [x] i18n support (English + Portuguese Brazil)
