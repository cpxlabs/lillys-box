...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#10222d' },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 12, backgroundColor: '#0b1820' },
  backText: { fontSize: 16, color: '#fff', fontWeight: '600' },
  scoreText: { fontSize: 14, fontWeight: '700', color: '#fff' },
  stepsText: { fontSize: 14, fontWeight: '700', color: '#d7eaf7' },
  metaBar: { flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', backgroundColor: '#163446', paddingVertical: 8 },
  metaText: { color: '#d7eaf7', fontWeight: '600', fontSize: 12 },
  world: { flexDirection: 'row', flexWrap: 'wrap', alignSelf: 'center', width: 350, height: 350, marginTop: 16, borderRadius: 12, overflow: 'hidden', borderWidth: 2, borderColor: '#3d6178' },
  tile: { width: `${100 / WORLD_SIZE}%`, height: `${100 / WORLD_SIZE}%`, justifyContent: 'center', alignItems: 'center', backgroundColor: '#24485d', borderWidth: 0.5, borderColor: '#183242' },
  tileEmoji: { fontSize: 16, opacity: 0.7 },
  playerTile: { backgroundColor: '#fbc02d' },
  player: { fontSize: 18 },
  controls: { marginTop: 16, alignItems: 'center' },
  controlRow: { flexDirection: 'row', gap: 12, marginBottom: 8 },
  controlBtn: { width: 56, height: 44, backgroundColor: '#2e5a72', borderRadius: 10, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#6d9bb4' },
  controlText: { color: '#fff', fontSize: 20, fontWeight: '700' },
  caughtPets: { marginTop: 10, paddingHorizontal: 16, paddingBottom: 12 },
  caughtTitle: { color: '#d7eaf7', fontWeight: '700', marginBottom: 6 },
  petList: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  petItem: { fontSize: 24, opacity: 0.28 },
  petCaught: { opacity: 1 },
  encounterOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.62)', justifyContent: 'center', alignItems: 'center' },
  encounterModal: { width: '82%', backgroundColor: '#fff', borderRadius: 20, padding: 20, alignItems: 'center' },
  encounterTitle: { fontSize: 22, color: '#1a1a1a', fontWeight: '800', textAlign: 'center' },
  encounterPet: { fontSize: 64, marginVertical: 8 },
  encounterMeta: { fontSize: 13, fontWeight: '600', color: '#425f70' },
  encounterActions: { width: '100%', marginTop: 14, gap: 8 },
  encounterBtn: { backgroundColor: '#2e7d32', borderRadius: 12, paddingVertical: 12, alignItems: 'center' },
  encounterBtnSnack: { backgroundColor: '#f57c00', borderRadius: 12, paddingVertical: 12, alignItems: 'center' },
  encounterBtnText: { color: '#fff', fontWeight: '700', fontSize: 16 },
  encounterBtnSecondary: { backgroundColor: '#e9eef2', borderRadius: 12, paddingVertical: 12, alignItems: 'center' },
  encounterBtnSecondaryText: { color: '#2a3d4a', fontWeight: '700', fontSize: 16 },
  catching: { marginTop: 12, alignItems: 'center' },
  catchingText: { fontSize: 15, color: '#2a3d4a', marginBottom: 8, fontWeight: '600' },
