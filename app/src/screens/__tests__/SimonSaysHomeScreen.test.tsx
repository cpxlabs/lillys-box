...
describe('SimonSaysHomeScreen', () => {
  ...
  it('renders title and play button', () => {
    const { getByText } = render(
      <SimonSaysHomeScreen navigation={navigation as any} />
    );
    expect(getByText('simonSays.home.title')).toBeTruthy();
    expect(getByText('simonSays.home.play')).toBeTruthy();
  });
  ...
  it('shows best score when greater than 0', () => {
    ...
    expect(getByText('simonSays.home.bestScore')).toBeTruthy();
  });
  ...
  it('does not show best score when 0', () => {
    ...
    expect(queryByText('simonSays.home.bestScore')).toBeNull();
  });
  ...
  it('navigates to game on play press', () => {
    ...
    fireEvent.press(getByText('simonSays.home.play'));
    expect(mockNavigate).toHaveBeenCalledWith('SimonSaysGame');
  });
