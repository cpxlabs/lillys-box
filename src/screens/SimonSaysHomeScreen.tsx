...
type Props = {
  navigation: ScreenNavigationProp<'SimonSaysHome'>;
};

export const SimonSaysHomeScreen: React.FC<Props> = ({ navigation }) => {
  const { t } = useTranslation();
  const { bestScore } = useSimonSays();

  const handlePlay = () => {
    navigation.navigate('SimonSaysGame');
  };
