...
type Props = { navigation: ScreenNavigationProp<'WeatherWizardHome'> };
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 36, fontWeight: '800', color: '#ff7043', marginBottom: 8 },
  ...
  bestScoreValue: { fontSize: 32, fontWeight: '800', color: '#ff7043' },
