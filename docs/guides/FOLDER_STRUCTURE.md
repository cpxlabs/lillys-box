...
- `package-lock.json` - Root-level locked dependencies

### App Dependencies
- `app/package.json` - React Native/Expo dependencies
- lockfile (generated by your package manager)
...
See the design system docs in [`docs/design-system/`](../design-system/) for sprite and UI guidance.
