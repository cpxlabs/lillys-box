...
describe('ConnectDotsHomeScreen', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('renders title and play button', () => {
    const { getByText } = render(
      <ConnectDotsHomeScreen navigation={navigation as any} />
    );
    expect(getByText('connectDots.home.title')).toBeTruthy();
    expect(getByText('connectDots.home.play')).toBeTruthy();
  });
  ...
  it('shows best score when greater than 0', () => {
    ...
    expect(getByText('connectDots.home.bestScore')).toBeTruthy();
  });
  ...
  it('does not show best score when 0', () => {
    ...
    expect(queryByText('connectDots.home.bestScore')).toBeNull();
  });
  ...
  it('navigates to game on play press', () => {
    ...
    fireEvent.press(getByText('connectDots.home.play'));
    expect(mockNavigate).toHaveBeenCalledWith('ConnectDotsGame');
  });
