...
describe('PetChefHomeScreen', () => {
  ...
  it('renders title and play button', () => {
    const { getByText } = render(
      <PetChefHomeScreen navigation={navigation as any} />
    );
    expect(getByText('petChef.home.title')).toBeTruthy();
    expect(getByText('petChef.home.play')).toBeTruthy();
  });
  ...
  it('shows best score when greater than 0', () => {
    ...
    expect(getByText('petChef.home.bestScore')).toBeTruthy();
  });
  ...
  it('does not show best score when 0', () => {
    ...
    expect(queryByText('petChef.home.bestScore')).toBeNull();
  });
  ...
  it('navigates to game on play press', () => {
    ...
    fireEvent.press(getByText('petChef.home.play'));
    expect(mockNavigate).toHaveBeenCalledWith('PetChefGame');
  });
