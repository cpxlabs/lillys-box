...
describe('PetExplorerHomeScreen', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('renders title and play button', () => {
    const { getByText } = render(
      <PetExplorerHomeScreen navigation={navigation as any} />
    );
    expect(getByText('petExplorer.home.title')).toBeTruthy();
    expect(getByText('petExplorer.home.play')).toBeTruthy();
  });
  ...
  it('shows best score when greater than 0', () => {
    ...
    expect(getByText('petExplorer.home.bestScore')).toBeTruthy();
  });
  ...
  it('does not show best score when 0', () => {
    ...
    expect(queryByText('petExplorer.home.bestScore')).toBeNull();
  });
  ...
  it('navigates to game on play press', () => {
    ...
    fireEvent.press(getByText('petExplorer.home.play'));
    expect(mockNavigate).toHaveBeenCalledWith('PetExplorerGame');
  });
