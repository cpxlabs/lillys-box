...
describe('BalloonFloatHomeScreen', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('renders title and play button', () => {
    const { getByText } = render(
      <BalloonFloatHomeScreen navigation={navigation as any} />
    );
    expect(getByText('balloonFloat.home.title')).toBeTruthy();
    expect(getByText('balloonFloat.home.play')).toBeTruthy();
  });
  ...
  it('shows best score when greater than 0', () => {
    ...
    expect(getByText('balloonFloat.home.bestScore')).toBeTruthy();
  });
  ...
  it('does not show best score when 0', () => {
    ...
    expect(queryByText('balloonFloat.home.bestScore')).toBeNull();
  });
  ...
  it('navigates to game on play press', () => {
    ...
    fireEvent.press(getByText('balloonFloat.home.play'));
    expect(mockNavigate).toHaveBeenCalledWith('BalloonFloatGame');
  });
