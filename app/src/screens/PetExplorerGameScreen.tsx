  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.consoleBody}>
        <View style={styles.topScreenShell}>
          <View style={styles.header}>
            <TouchableOpacity onPress={handleBack}><Text style={styles.backText}>← {t('common.back')}</Text></TouchableOpacity>
            <Text style={styles.brandText}>PET EXPLORER DX</Text>
          </View>

          <View style={styles.metaBar}>
            <Text style={styles.metaText}>{t('petExplorer.game.team')}: {caughtPets.size}/{PARTY_LIMIT}</Text>
            <Text style={styles.metaText}>{t('petExplorer.game.level')}: {playerLevel}</Text>
            <Text style={styles.metaText}>👣 {steps}</Text>
          </View>

          <View style={styles.metaBarSecondary}>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#8ea59a', paddingHorizontal: 12, paddingVertical: 8 },
  consoleBody: {
  ...
  header: {
    ...
    paddingVertical: 8,
    backgroundColor: '#2e3b31',
  },
  backText: { fontSize: 11, color: '#d8e1d0', fontWeight: '800', textTransform: 'uppercase' },
  brandText: { fontSize: 11, color: '#d8e1d0', fontWeight: '900', letterSpacing: 0.8 },
  metaBar: { flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', backgroundColor: '#73856f', paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: '#2e3b31' },
  metaBarSecondary: { flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', backgroundColor: '#7c9079', paddingVertical: 6, borderBottomWidth: 2, borderBottomColor: '#2e3b31' },
  metaText: { color: '#1d2a22', fontWeight: '800', fontSize: 10, textTransform: 'uppercase' },
  world: { flexDirection: 'row', flexWrap: 'wrap', alignSelf: 'center', width: 350, height: 350, marginVertical: 10, borderRadius: 4, overflow: 'hidden', borderWidth: 3, borderColor: '#2e3b31', backgroundColor: '#516250' },
  tile: { width: `${100 / WORLD_SIZE}%`, height: `${100 / WORLD_SIZE}%`, justifyContent: 'center', alignItems: 'center', backgroundColor: '#72856f', borderWidth: 1, borderColor: '#5f705d' },
  tileEmoji: { fontSize: 16, opacity: 0.9 },
  playerTile: { backgroundColor: '#d6e39f' },
  player: { fontSize: 18 },
  bottomDeck: { marginTop: 10, backgroundColor: '#c9d3c6', borderRadius: 18, borderWidth: 4, borderColor: '#3b4a3f', paddingVertical: 14, paddingHorizontal: 8, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' },
  controls: { alignItems: 'center' },
  controlRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8, minHeight: 44 },
  controlBtn: { width: 56, height: 44, backgroundColor: '#48574a', borderRadius: 6, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#27322b' },
  centerPivot: { width: 24, height: 24, borderRadius: 12, backgroundColor: '#8a9587', marginHorizontal: 8 },
  controlText: { color: '#dce8c2', fontSize: 20, fontWeight: '900' },
  caughtPets: { maxWidth: 170, borderWidth: 2, borderColor: '#3b4a3f', borderRadius: 10, backgroundColor: '#b9c5b4', paddingHorizontal: 10, paddingVertical: 8 },
  caughtTitle: { color: '#243228', fontWeight: '800', marginBottom: 6, textTransform: 'uppercase', fontSize: 11 },
  petList: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  petItem: { fontSize: 22, opacity: 0.28 },
  petCaught: { opacity: 1 },
  encounterOverlay: { flex: 1, backgroundColor: 'rgba(25,30,25,0.75)', justifyContent: 'center', alignItems: 'center' },
  encounterModal: { width: '82%', backgroundColor: '#c7d1c2', borderRadius: 10, borderWidth: 3, borderColor: '#2e3b31', padding: 20, alignItems: 'center' },
  encounterTitle: { fontSize: 20, color: '#243228', fontWeight: '900', textAlign: 'center', textTransform: 'uppercase', letterSpacing: 1 },
  encounterPet: { fontSize: 64, marginVertical: 8 },
  encounterMeta: { fontSize: 12, fontWeight: '700', color: '#314034', textTransform: 'uppercase', letterSpacing: 0.5 },
  encounterActions: { width: '100%', marginTop: 14, gap: 8 },
  encounterBtn: { backgroundColor: '#506452', borderRadius: 6, borderWidth: 2, borderColor: '#2e3b31', paddingVertical: 12, alignItems: 'center' },
  encounterBtnSnack: { backgroundColor: '#677a62', borderRadius: 6, borderWidth: 2, borderColor: '#2e3b31', paddingVertical: 12, alignItems: 'center' },
  encounterBtnText: { color: '#fff', fontWeight: '900', fontSize: 14, textTransform: 'uppercase', letterSpacing: 1 },
  encounterBtnSecondary: { backgroundColor: '#9ca89a', borderRadius: 6, borderWidth: 2, borderColor: '#3b4a3f', paddingVertical: 12, alignItems: 'center' },
  encounterBtnSecondaryText: { color: '#1f2b21', fontWeight: '800', fontSize: 14, textTransform: 'uppercase', letterSpacing: 1 },
  catching: { marginTop: 12, alignItems: 'center' },
  catchingText: { fontSize: 14, color: '#2d3c30', marginBottom: 8, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1 },
  catchingAnimation: { fontSize: 28 },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(25,30,25,0.75)', justifyContent: 'center', alignItems: 'center' },
  modalContent: { backgroundColor: '#c7d1c2', borderRadius: 10, borderWidth: 3, borderColor: '#2e3b31', padding: 32, alignItems: 'center', width: '80%' },
  modalEmoji: { fontSize: 64, marginBottom: 12 },
  modalTitle: { fontSize: 24, fontWeight: '900', color: '#243228', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 2 },
  modalScore: { fontSize: 20, color: '#314034', fontWeight: '800', marginBottom: 24, textTransform: 'uppercase', letterSpacing: 1 },
  modalButton: { backgroundColor: '#506452', paddingVertical: 14, paddingHorizontal: 40, borderRadius: 6, borderWidth: 2, borderColor: '#2e3b31', marginBottom: 12, width: '100%', alignItems: 'center' },
  ...
  modalSecondaryText: { fontSize: 14, color: '#314034', fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
});
